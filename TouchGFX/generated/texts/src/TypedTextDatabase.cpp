...
extern touchgfx::GeneratedFont& getFont_ariblk_24_4bpp();
extern touchgfx::GeneratedFont& getFont_ariblk_12_4bpp();
extern touchgfx::GeneratedFont& getFont_YTTE08_TTF_14_4bpp();

const touchgfx::Font* _fonts[] =
{
    &(getFont_ariblk_24_4bpp()),
    &(getFont_ariblk_12_4bpp()),
    &(getFont_YTTE08_TTF_14_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        _fonts[0] = &(getFont_ariblk_24_4bpp());
        break;
    case 1:
        _fonts[1] = &(getFont_ariblk_12_4bpp());
        break;
    case 2:
        _fonts[2] = &(getFont_YTTE08_TTF_14_4bpp());
        break;
    }
}
}  // namespace TypedTextDatabase
