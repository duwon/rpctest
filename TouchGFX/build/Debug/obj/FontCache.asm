; Listing generated by Microsoft (R) Optimizing Compiler Version 19.22.27905.0 
	...
	TITLE	C:\TouchGFXProjects\RPCTest\TouchGFX\generated\fonts\src\FontCache.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__DAF6CA74_FontCache@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_1LK@KOBDAFPG@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1LK@KOBDAFPG@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
CONST	SEGMENT
??_C@_1LK@KOBDAFPG@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'T', 00H, 'o', 00H, 'u', 00H, 'c', 00H
	DB	'h', 00H, 'G', 00H, 'F', 00H, 'X', 00H, 'P', 00H, 'r', 00H, 'o'
	DB	00H, 'j', 00H, 'e', 00H, 'c', 00H, 't', 00H, 's', 00H, '\', 00H
	DB	'R', 00H, 'P', 00H, 'C', 00H, 'T', 00H, 'e', 00H, 's', 00H, 't'
...
; _this$ = ecx
; File C:\TouchGFXProjects\RPCTest\TouchGFX\generated\fonts\include\fonts\CachedFont.hpp
; Line 60
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __D7AF7719_CachedFont@hpp
...
; _this$ = ecx
; File C:\TouchGFXProjects\RPCTest\TouchGFX\generated\fonts\src\FontCache.cpp
; Line 372
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __DAF6CA74_FontCache@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 373
	mov	eax, DWORD PTR _this$[ebp]
...
; _this$ = ecx
; File C:\TouchGFXProjects\RPCTest\Middlewares\ST\touchgfx\framework\include\touchgfx\TypedText.hpp
; Line 221
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __35DAAA0F_TypedText@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 222
...
$LN3@assertVali:
	mov	esi, esp
	push	222					; 000000deH
	push	OFFSET ??_C@_1LK@KOBDAFPG@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
