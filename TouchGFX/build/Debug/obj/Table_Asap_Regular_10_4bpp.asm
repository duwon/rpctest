; Listing generated by Microsoft (R) Optimizing Compiler Version 19.22.27905.0 
	...
	TITLE	C:\TouchGFXProjects\RPCTest\TouchGFX\generated\fonts\src\Table_Asap_Regular_10_4bpp.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?glyphs_Asap_Regular_10_4bpp@@3QBUGlyphNode@touchgfx@@B ; glyphs_Asap_Regular_10_4bpp
PUBLIC	?unicodes_Asap_Regular_10_4bpp@@3QBQBEB		; unicodes_Asap_Regular_10_4bpp
EXTRN	?unicodes_Asap_Regular_10_4bpp_0@@3QBEB:BYTE	; unicodes_Asap_Regular_10_4bpp_0
msvcjmc	SEGMENT
...
__2121A31E_Table_Asap_Regular_10_4bpp@cpp DB 01H
msvcjmc	ENDS
CONST	SEGMENT
?glyphs_Asap_Regular_10_4bpp@@3QBUGlyphNode@touchgfx@@B DD 00H ; glyphs_Asap_Regular_10_4bpp
	DW	020H
	DB	00H
	DB	00H
	DB	00H
	...
	DB	00H
	DB	00H
?unicodes_Asap_Regular_10_4bpp@@3QBQBEB DD FLAT:?unicodes_Asap_Regular_10_4bpp_0@@3QBEB ; unicodes_Asap_Regular_10_4bpp
CONST	ENDS
...
PUBLIC	?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ ; getFont_Asap_Regular_10_4bpp
...
EXTRN	?kerning_Asap_Regular_10_4bpp@@3QBUKerningNode@touchgfx@@B:BYTE ; kerning_Asap_Regular_10_4bpp
EXTRN	??_7type_info@@6B@:QWORD			; type_info::`vftable'
EXTRN	___security_cookie:DWORD
EXTRN	__tls_array:DWORD
EXTRN	__tls_index:DWORD
_BSS	SEGMENT
?Asap_Regular_10_4bpp@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4V23@A DB 024H DUP (?) ; `getFont_Asap_Regular_10_4bpp'::`2'::Asap_Regular_10_4bpp
?$TSS0@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA DD 01H DUP (?) ; TSS0<`template-parameter-2',etFont_Asap_Regular_10_4bpp,touchgfx::AAAVGeneratedFont,void,int, ?? &>
_BSS	ENDS
;	COMDAT rtc$TMZ
rtc$TMZ	SEGMENT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ$0
__ehfuncinfo$?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
;	COMDAT ??__FAsap_Regular_10_4bpp@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ
text$yd	SEGMENT
??__FAsap_Regular_10_4bpp@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ PROC ; `getFont_Asap_Regular_10_4bpp'::`2'::`dynamic atexit destructor for 'Asap_Regular_10_4bpp'', COMDAT
	push	ebp
	mov	ebp, esp
	...
	rep stosd
	mov	ecx, OFFSET ?Asap_Regular_10_4bpp@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4V23@A
	...
	pop	ebp
	ret	0
??__FAsap_Regular_10_4bpp@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ ENDP ; `getFont_Asap_Regular_10_4bpp'::`2'::`dynamic atexit destructor for 'Asap_Regular_10_4bpp''
text$yd	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
_TEXT	SEGMENT
__$EHRec$ = -12						; size = 12
?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ PROC ; getFont_Asap_Regular_10_4bpp, COMDAT
; File C:\TouchGFXProjects\RPCTest\TouchGFX\generated\fonts\src\Table_Asap_Regular_10_4bpp.cpp
; Line 29
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
	...
	mov	ecx, OFFSET __2121A31E_Table_Asap_Regular_10_4bpp@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 30
	mov	eax, DWORD PTR __tls_index
	mov	ecx, DWORD PTR fs:__tls_array
	mov	edx, DWORD PTR [ecx+eax*4]
	mov	eax, DWORD PTR ?$TSS0@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA
	cmp	eax, DWORD PTR __Init_thread_epoch[edx]
	jle	SHORT $LN2@getFont_As
	push	OFFSET ?$TSS0@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA
	call	__Init_thread_header
	add	esp, 4
	cmp	DWORD PTR ?$TSS0@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA, -1
	jne	SHORT $LN2@getFont_As
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	push	0
	push	0
	push	63					; 0000003fH
	push	OFFSET ?kerning_Asap_Regular_10_4bpp@@3QBUKerningNode@touchgfx@@B ; kerning_Asap_Regular_10_4bpp
	push	OFFSET ?unicodes_Asap_Regular_10_4bpp@@3QBQBEB ; unicodes_Asap_Regular_10_4bpp
	push	1
	push	0
	push	0
	push	4
	...
	push	10					; 0000000aH
	push	8
	push	OFFSET ?glyphs_Asap_Regular_10_4bpp@@3QBUGlyphNode@touchgfx@@B ; glyphs_Asap_Regular_10_4bpp
	mov	ecx, OFFSET ?Asap_Regular_10_4bpp@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4V23@A
	...
	push	OFFSET ??__FAsap_Regular_10_4bpp@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@YAXXZ ; `getFont_Asap_Regular_10_4bpp'::`2'::`dynamic atexit destructor for 'Asap_Regular_10_4bpp''
	call	_atexit
	add	esp, 4
...
$LN2@getFont_As:
; Line 31
	mov	eax, OFFSET ?Asap_Regular_10_4bpp@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4V23@A
; Line 32
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ$0:
	push	OFFSET ?$TSS0@?1??getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ@4HA
	call	__Init_thread_abort
	pop	ecx
	ret	0
__ehhandler$?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-208]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?getFont_Asap_Regular_10_4bpp@@YAAAVGeneratedFont@touchgfx@@XZ ENDP ; getFont_Asap_Regular_10_4bpp
; Function compile flags: /Odtp /RTCsu /ZI
